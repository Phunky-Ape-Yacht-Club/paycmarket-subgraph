...
export class PAYC extends ethereum.SmartContract {
  static bind(address: Address): PAYC {
    return new PAYC("PAYC", address);
  }
  ...
  partnerOne(): Address {
    let result = super.call("partnerOne", "partnerOne():(address)", []);

    return result[0].toAddress();
  }

  try_partnerOne(): ethereum.CallResult<Address> {
    let result = super.tryCall("partnerOne", "partnerOne():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  partnerThree(): Address {
    let result = super.call("partnerThree", "partnerThree():(address)", []);

    return result[0].toAddress();
  }

  try_partnerThree(): ethereum.CallResult<Address> {
    let result = super.tryCall("partnerThree", "partnerThree():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  partnerTwo(): Address {
    let result = super.call("partnerTwo", "partnerTwo():(address)", []);

    return result[0].toAddress();
  }

  try_partnerTwo(): ethereum.CallResult<Address> {
    let result = super.tryCall("partnerTwo", "partnerTwo():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  staffOne(): Address {
    let result = super.call("staffOne", "staffOne():(address)", []);

    return result[0].toAddress();
  }

  try_staffOne(): ethereum.CallResult<Address> {
    let result = super.tryCall("staffOne", "staffOne():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  staffTwo(): Address {
    let result = super.call("staffTwo", "staffTwo():(address)", []);

    return result[0].toAddress();
  }

  try_staffTwo(): ethereum.CallResult<Address> {
    let result = super.tryCall("staffTwo", "staffTwo():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
